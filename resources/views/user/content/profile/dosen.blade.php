                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-body text-center">
                            ...
                            <div class="d-grid gap-2 mt-3">
                                <a href="{{ route('profile.dosen', ['action' => 'detail']) }}"
                                    class="btn btn-outline-primary @if ($action == 'detail') active @endif">
                                    <i class="fas fa-eye me-2"></i>Detail Profil
                                </a>
                                <a href="{{ route('profile.dosen', ['action' => 'edit-profile']) }}"
                                    class="btn btn-outline-primary @if (request()->get('action') == 'edit-profile') active @endif">
                                    <i class="fas fa-user-edit me-2"></i>Edit Profil
                                </a>
                                <a href="{{ route('profile.dosen', ['action' => 'edit-password']) }}"
                                    class="btn btn-outline-primary @if (request()->get('action') == 'edit-password') active @endif">
                            ...
                            <div class="card-body">
                                <form id="profileForm" method="POST" action="{{ route('user.updateProfile') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="jurusan" name="nama_jurusan" class="form-control"
                                            value="{{ $user->jurusan ? $user->jurusan->nama_jurusan : 'Belum ditentukan' }}"
                                            disabled>
                                    </div>
                                    <div class="d-grid gap-2 mt-3">

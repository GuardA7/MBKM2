@extends(Auth::user()->role == 'admin' ? 'admin.layouts.app' : 'user.layouts.app')

@section('content')
<div class="container">
    <h3 class="text-center text-primary fw-bold mb-4 mt-3">Grafik Sertifikat yang Diunggah</h3>
    ...
    <script>
        ...
        function filterChart() {
            ...
            window.location.href = `{{ route('grafik.grafik') }}?role=${selectedRole}&year=${selectedYear}`;
        }
    </script>
    </div>
@endsection

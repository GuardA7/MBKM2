        ...
        <div class="container-fluid px-4">
            ...
            @if (session('tambah_success'))
                <div class="alert alert-success alert-dismissible fade show" role="alert">
                    <strong>Tambah Berhasil!</strong> Mahasiswa telah berhasil ditambahkan.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            @endif

            <a href="{{ route('admin.dosen.create') }}" class="btn btn-sm btn-success mb-2">
                    ...
                    columns: [{
                        ...
                        },
                        {
                            ...
                            render: function(data, type, row) {
                                return `
                            <a class="btn btn-info btn-sm mx-1" href="{{ route('admin.mahasiswa.index', '') }}/${row.id}">
                                <i class="fas fa-eye"></i> 
                            </a>
                            <a class="btn btn-primary btn-sm mx-1" href="{{ route('admin.mahasiswa.edit', '') }}/${row.id}">
                                <i class="fas fa-pen"></i> 
                            </a>
                            <form action="{{ route('admin.mahasiswa.destroy', '') }}/${row.id}" method="POST" class="d-inline delete-form">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}

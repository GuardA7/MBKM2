    ...
    <div class="container-fluid px-4">
        ...
        @if (session('tambah_success'))
            <div class="alert alert-success alert-dismissible fade show" role="alert">
                <strong>Tambah Berhasil!</strong> Dosen telah berhasil ditambahkan.
    ...
    $(document).ready(function() {
            ...
            columns: [
                ...
                { data: 'no_hp', name: 'no_hp' },
                {
                    ...
                    render: function(data, type, row) {
                        return `
                            <a class="btn btn-info btn-sm mx-1" href="{{ route('admin.dosen.index', '') }}/${row.id}">
                                <i class="fas fa-eye"></i> 
                            </a>
                            <a class="btn btn-primary btn-sm mx-1" href="{{ route('admin.dosen.edit', '') }}/${row.id}">
                                <i class="fas fa-pen"></i> 
                            </a>
                            <form action="{{ route('admin.dosen.destroy', '') }}/${row.id}" method="POST" class="d-inline delete-form">
                                {{ csrf_field() }}
                                {{ method_field('DELETE') }}
        ...
        $(document).on('click', '.delete-button', function(e) {
            ...
            Swal.fire({
                ...
                text: "Hapus dosen ini? ID=" + deleteId,
                icon: 'warning',
